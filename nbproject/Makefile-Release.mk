...
${OBJECTDIR}/src/apple.o: src/apple.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/apple.o src/apple.cpp

${OBJECTDIR}/src/apple_tree.o: src/apple_tree.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/apple_tree.o src/apple_tree.cpp
